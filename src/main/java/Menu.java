...
// Changes:Type of object(Product),Variable with new object created(newProduct)
...
//        TypedQuery<Product> query = em.createQuery("FROM Product ORDER BY LOWER(name)", Product.class).setMaxResults(3);
